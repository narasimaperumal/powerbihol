...
<a name="RedeemAzurePass"></a>
## Redeem Azure Pass ##
1.	Visit https://www.microsoftazurepass.com/Home/HowTo for the Redeem Guide.

<a name="CreateDSVM"></a>
## Create Data Science Virtual Machine ##
1.	Login to https://portal.azure.com
1. Click **+ New** icon in the left side panel
1. Search for **DSVM** and select **Data Science Virtual Machine(DSVM) - windows 2016**
1. Click **Create**
1. Enter **Name**, **Username** and **Password**
1. Enter a name for the **Resource Group**
1. Click **Ok** and proceed
1. Once the Virtual Machine is created, click **Connect** to open the Virtual Machine
